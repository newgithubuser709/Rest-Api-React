...
import { fetchAction } from "../../reducers/MenProductsSlice";
  ...
  return (
    <>
      ...
      <section className="men__section">
        <main className="men__sect__container">
          <div className="men_sect_grid">
            {/* box 1  */}
            <div className="menSectGrid__box_1">
              {/* head text  */}
              <div className="header__text">
                <p className="path__show">HOME / MEN</p>
                <h1 className="heading">MENS:</h1>
                <p className="info">
                  Morat offers a vast selection of men’s clothing to shop. Each
                  season, you’ll find a careful assortment of clothing no matter
