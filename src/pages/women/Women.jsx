...
import { fetchAction } from "../../reducers/WomenProductsSlice";
...
const Women = () => {
  ...
  // women products state selector
  const { loading, promiseState, productList, error } = useSelector(
    (state) => state.WomenProductsSliceKey
  );
  // women products fetch functionality
  useEffect(() => {
  ...
  return (
    <>
      ...
      <section className="women__section">
        <main className="women__sect__container">
          <div className="women_sect_grid">
            {/* box 1  */}
            <div className="womenSectGrid__box_1">
              {/* head text  */}
              <div className="header__text">
                <p className="path__show">HOME / WOMEN</p>
                <h1 className="heading">womens:</h1>
                <p className="info">
                  Morat offers a vast selection of women’s clothing to shop.
                  Each season, find a careful assortment of clothing no matter
                  the season, trend-driven and classic pieces are always
                  available .Morat is committed to helping shoppers be their
                  most stylish selves
                </p>
              </div>
